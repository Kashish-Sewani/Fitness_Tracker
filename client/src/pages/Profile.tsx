...
import { Calendar, LogOutIcon, MoonIcon, ScaleIcon, SunIcon, Target, User, UserIcon } from "lucide-react";
...
const Profile = () => {
  ...
  const getStats = ()=>{
    ...
    const todayFoodEntries = allFoodLogs?.filter((f: any) => 
      f.date === today || f.createdAt?.split('T')[0] === today
    ).length || 0;
    const todayActivities = allActivityLogs?.filter((a: any) => 
      a.date === today || a.createdAt?.split('T')[0] === today
    ).length || 0;
    return {totalFoodEntries: todayFoodEntries, totalActivities: todayActivities}
  }
      ...
      <div className='profile-content'>
        ...
        <Card>
            ...
            {isEditing ? (
              <div className='space-y-4'>
                ...
                <div className='flex galp-3 pt-2'>
        ...
        <div className='space-y-4'>
            ...
            <div className="lg:hidden">
                ...
                dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-700
                dark:hover:text-slate-200 rounded-lg transition-colors duration-200 cursor-pointer'>
