          ...
          {step === 1 && (
            <div className='space-y-6'>
              ...
              <Input label="Age" type="number" className='max-w-2xl' value={formData.age}
                onChange={(v) => updateField('age', v)} placeholder="Enter your age" min={13} max={120}
                required />
            </div>
          )}
            ...
            <div className='space-y-6 onboarding-wrapper'>
              <div className='flex items-center gap-4 mb-8'>
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Help us calculate your progress</p>
                </div>
              </div>
              <div className='flex flex-col gap-4 max-w-2xl'>

                <Input label="Weight (kg)" type="number" value={formData.weight}
                  onChange={(v) => updateField('weight', v)} placeholder="Enter your weight" min={20} max={300}
                  required />
            ...
            <div className='space-y-6 onboarding-wrapper'>
              ...
              <div className='space-y-8 max-w-lg'>
                ...
                <div className='space-y-6'>
                 ...
                 value={formData.dailyCalorieIntake} onChange={(v) => updateField('dailyCalorieIntake', v)} unit="kcal" infoText="The total calories you plan to consume each day."/>

                 <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} 
                 value={formData.dailyCalorieBurn} onChange={(v) => updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories you aim to burn through exercise and activity each day."/>
                </div>
              </div>
